                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('eventos.criar') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="premio" rows="7" type="text" class="form-control @error('premio') is-invalid @enderror" name="premio" autocomplete="premio">{{ old('premio') }}</textarea>
                                @error('premio')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="vencedor" rows="7" type="text" class="form-control @error('premio') is-invalid @enderror" name="vencedor" value="{{ old('vencedor') }}" autocomplete="vencedor">
                                @error('vencedor')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
