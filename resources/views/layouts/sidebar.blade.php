<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('home')}}">
            ...
            <span class="ms-1 font-weight-bold text-white">CIDADE REAL</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="{{ route('usuarios.listar')}}">
                    ...
                    <span class="nav-link-text ms-1">Usúarios</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" href="{{ route('ver.pontos')}}">
                    ...
                    <span class="nav-link-text ms-1">Pontos</span>
                </a>
            </li>
            <!-- <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('usuarios.ver.editar', auth()->user()->id)}}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('usuarios.ver.bater.ponto')}}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">person</i>
                    </div>
                    <span class="nav-link-text ms-1">Bater Ponto</span>
                </a>
            </li>
        </ul>
    </div>
