            ...
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        ...
                        <h4 class="mb-0">{{ $data['eventosCount']}}</h4>
                    </div>
                </div>
                <hr class="dark horizontal my-0">
                <div class="card-footer p-3">
                    <p class="mb-0"><span class="text-success text-sm font-weight-bolder">{{ $data['eventosToday']}} </span>adicionados hoje</p>
                </div>
            </div>
        </div>
        <div class="col-xl-6 col-sm-6 mb-xl-0 mb-4">
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        <p class="text-sm mb-0 text-capitalize">Total de Úsuarios</p>
...
<script>
    ...
    function buscaDadosEventos() {
        $.ajax({
            url: "{{ route('eventos.buscar.dados.ajax')}}",
            method: 'get'
        }).done(function(response) {
            makeChartEventos(response)
        })
    }
